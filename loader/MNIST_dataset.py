...
class TranslatingMNIST:
    ...
    def __init__(
        ...
        **kwargs):
        ...
        targets = []
        for digit in digits:
            file_name = f'TranslatingMNIST-digit={digit}.pkl'
            try:
                print(os.path.join(root, 'TranslatingMNIST', file_name))
        ...
        if verbose:
            print(f"TranslatingMNIST split {split} | {self.data.size()}")
