...
from trainers.trainer import BaseTrainer, GraphTrainer
...
def get_trainer(optimizer, cfg):
    ...
    elif trainer_type == "graph":
        trainer = GraphTrainer(optimizer, cfg["training"], cfg["data"]["training"], device=device)
    return trainer
